...
class IncremenatorInterruption extends Thread {
...
class ProgramInterruption {
    ...
    static IncremenatorInterruption mInc;    //Объект побочного потока

    public static void main(String[] args) {
        mInc = new IncremenatorInterruption();    //Создание потока
